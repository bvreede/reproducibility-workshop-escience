...
![research_compendium](images/compendium_small.png)

--

- Stick with the convention of your peers;

- Keep data, methods, output separate; 
...
![research_compendium](images/reproducible-data-analysis_042.png)
.footnote[Source: [Karthik Ram, 2019 (rstudio::conf )](https://github.com/karthik/rstudio2019)]
...
![compendium_structure](images/reproducible-data-analysis-13.png)
